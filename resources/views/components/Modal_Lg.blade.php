<div id="{{isset($id) ? $id: 'Null'}}" class="modal fade  " tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog {{isset($modal_Size) ? $modal_Size: 'modal-lg'}}">
        <div class="modal-content">
            ...
            <div id="{{isset($modal_Footer_Id) ? $modal_Footer_Id: ''}}" class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">{{__('supermarket::storeCashier/Dashboard.public.close')}}</button>
